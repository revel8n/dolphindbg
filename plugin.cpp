...
//--------------------------------------------------------------------------
char comment[] = "dolphin debugger plugin by revel8n.";

char help[] =
"dolphin debugger plugin by revel8n.\n"
"\n"
"This module lets you debug gamecube/wii programs running in the dolphin emulator.\n";
...
plugin_t PLUGIN =
{
    ...
    "dolphin debugger plugin",		// the preferred short name of the plugin
